 ...
 *
 * <p>Set by {@link TenantContextFilter} at the start of each request (from the JWT {@code
 * tenantId} claim) and cleared in the finally block so the value never leaks to the next request
 * on the same thread.
 *
