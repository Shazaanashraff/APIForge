 ...
 *
 * <p>When present, the test executor uses this threshold to assert that the actual response time is
 * below the declared SLA. Falls back to the global config value when absent.
 *
